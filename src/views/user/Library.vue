  ...
  <div class="library" id="library">
    ...
    <el-form :inline="true" :model="formSeletor" class="demo-form-inline demo-form-inline1">
      ...
      <el-form-item label="状态">
        <el-select v-model="formSeletor.isreturn" placeholder="剩余情况" width="50px">
          <el-option label="所有" value="所有"></el-option>
  ...
  export default {
    methods: {
      ...
      onSubmitSeletor () {
        ...
        this.currentPage = 1
        SelectSelector(this.formSeletor.sort, this.formSeletor.pub, this.formSeletor.isreturn).then(res => {
          // TODO
          /* this.tableData = res
          this.total = 6 */
          if (res) {
